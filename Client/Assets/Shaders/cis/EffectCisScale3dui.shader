...
// Write By Maoshu
// UI Scale Effect
Shader "UEP/Interface/SimpleScale(3dui)"
{
    Properties
    {
        _MainTex("_MainTex(主贴图)", 2D) = "white" {}
        _MainColor("_MainColor(颜色)", Color) = (1,1,1,1)
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float _UIMaskSoftnessX, _UIMaskSoftnessY, _TimeSpeed,_Scale,_Power, _MinScale, _PeriodOffset;
                ...
                v2f vert(appdata_t v)
                {
                    ...
                    if (_UniformScaleUI == 1.0) {
                        ...
                        OUT.vertex = UnityObjectToClipPos(scaledVertex);
                    }
                    else {
                        OUT.vertex = vPosition;
                    }
